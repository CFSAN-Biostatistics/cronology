def mlstHelp(params) {
    ...
    toolspecs = [
        ...
        'mlst_datadir': [
            clihelp: 'PubMLST data directory. ' +
                "Default: ${params.mlst_datadir}",
            cliflag: '--datadir',
            clivalue: (params.mlst_datadir ?: null)
        ],
        'mlst_blastdb': [
            clihelp: 'BLAST database directory. ' +
                "Default: ${params.mlst_blastdb}",
            cliflag: '--blastdb',
            clivalue: (params.mlst_blastdb ?: null)
        ]
    ]
